...
export default function Chatbot() {
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      ...
      const botMessage: ChatbotMessage = { role: 'bot', content: response.answer, actions: response.actions };
  ...
  return (
    <>
      <div className={cn(
        ...
        <Button
          size="icon"
          className="rounded-full w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg hover-lift p-0 overflow-hidden flex items-center justify-center"
        ...
        <div className="flex flex-col h-full bg-secondary/80 backdrop-blur-xl border border-border rounded-2xl shadow-2xl">
          <header className="flex items-center justify-between p-4 border-b border-border">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 bg-accent rounded-lg flex items-center justify-center ring-1 ring-border">
                  <Bot className="w-6 h-6 text-blue-400" />
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Coreveil AI Assistant</h3>
