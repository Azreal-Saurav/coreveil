  ...
  return (
    <footer className="relative border-t border-border py-8 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-muted-foreground/70 text-center sm:text-left">
          <p>&copy; {new Date().getFullYear()} Coreveil Automations. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
